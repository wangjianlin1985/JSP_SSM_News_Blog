...
-- Dumping database structure for ssm_news_sys
CREATE DATABASE IF NOT EXISTS `ssm_news_sys` /*!40100 DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci */;
USE `ssm_news_sys`;

-- Dumping structure for table ssm_news_sys.authority
...
-- Dumping data for table ssm_news_sys.authority: ~43 rows (approximately)
...
-- Dumping structure for table ssm_news_sys.c3p0testtable
DROP TABLE IF EXISTS `c3p0testtable`;
CREATE TABLE IF NOT EXISTS `c3p0testtable` (
  `a` char(1) DEFAULT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8;

-- Dumping data for table ssm_news_sys.c3p0testtable: ~0 rows (approximately)
/*!40000 ALTER TABLE `c3p0testtable` DISABLE KEYS */;
/*!40000 ALTER TABLE `c3p0testtable` ENABLE KEYS */;

-- Dumping structure for table ssm_news_sys.comment
...
-- Dumping data for table ssm_news_sys.comment: ~16 rows (approximately)
/*!40000 ALTER TABLE `comment` DISABLE KEYS */;
INSERT INTO `comment` (`id`, `newsId`, `nickname`, `content`, `createTime`) VALUES
	(4, 2, '哈哈哈', '测试', '2018-12-23 15:07:00'),
	(5, 2, '哈哈哈', '你好', '2018-12-23 15:07:13'),
	(6, 2, 'bagafa', 'gafafa好啊！', '2018-12-23 15:07:36'),
	(7, 2, 'ghafaf', 'gafafas棒啊！', '2018-12-23 15:08:36'),
	(8, 2, 'ghasfas', '哈哈哈哈！', '2018-12-23 15:08:43'),
	(9, 2, 'ghasfas', '评论测试v报告！', '2018-12-23 15:30:10'),
	(10, 2, 'ghasfas', '你好', '2018-12-23 15:40:21'),
	(11, 2, '小明', '人呢？', '2018-12-23 15:40:36'),
	(12, 3, 'ghasfas', '好想去啊！', '2018-12-23 15:41:20'),
	(13, 11, '娱乐纪检委', '祝你们幸福美满！', '2018-12-23 15:42:05'),
	(14, 7, 'ghasfas', '真厉害！', '2018-12-23 21:34:13'),
	(15, 2, '慢慢来', '有人说慢慢来会比较块！', '2018-12-23 21:34:52'),
	(16, 2, '小明', '小明是个好同学！', '2018-12-23 21:35:14'),
	(17, 2, 'ghasfas', '哈哈哈哈！', '2018-12-23 21:35:45'),
	(18, 13, '吃瓜群众', ' 这样就不好了吧！', '2018-12-23 21:44:36'),
	(19, 12, '12', '12121', '2019-10-10 22:13:37');
/*!40000 ALTER TABLE `comment` ENABLE KEYS */;

-- Dumping structure for table ssm_news_sys.log
...
-- Dumping data for table ssm_news_sys.log: ~55 rows (approximately)
...
INSERT INTO `log` (`id`, `content`, `createTime`) VALUES
	...
	(20, '用户名为{ghasfas}，角色为{普通用户}的用户登录成功!', '2018-12-16 19:17:46'),
	(21, '用户名为{admin}，角色为{超级管理员}的用户登录成功!', '2018-12-20 21:51:57'),
	(22, '用户名为{admin}，角色为{超级管理员}的用户登录成功!', '2018-12-20 21:58:51'),
	(23, '用户名为{admin}，角色为{超级管理员}的用户登录成功!', '2018-12-21 20:14:49'),
	(24, '用户名为{admin}，角色为{超级管理员}的用户登录成功!', '2018-12-21 20:22:49'),
	(25, '用户名为{admin}，角色为{超级管理员}的用户登录成功!', '2018-12-21 20:23:43'),
	(26, '用户名为{admin}，角色为{超级管理员}的用户登录成功!', '2018-12-21 21:07:39'),
	(27, '用户名为{admin}，角色为{超级管理员}的用户登录成功!', '2018-12-21 21:18:38'),
	(28, '用户名为{admin}，角色为{超级管理员}的用户登录成功!', '2018-12-21 22:03:27'),
	(29, '用户名为{admin}，角色为{超级管理员}的用户登录成功!', '2018-12-21 22:31:49'),
	(30, '用户名为{admin}，角色为{超级管理员}的用户登录成功!', '2018-12-21 22:32:58'),
	(31, '用户名为{admin}，角色为{超级管理员}的用户登录成功!', '2018-12-21 22:38:50'),
	(32, '用户名为{admin}，角色为{超级管理员}的用户登录成功!', '2018-12-22 10:26:00'),
	(33, '用户名为admin的用户登录时输入验证码错误!', '2018-12-22 10:36:53'),
	(34, '用户名为{admin}，角色为{超级管理员}的用户登录成功!', '2018-12-22 10:37:04'),
	(35, '用户名为{admin}，角色为{超级管理员}的用户登录成功!', '2018-12-22 11:08:04'),
	(36, '用户名为{admin}，角色为{超级管理员}的用户登录成功!', '2018-12-22 11:59:39'),
	(37, '用户名为{admin}，角色为{超级管理员}的用户登录成功!', '2018-12-22 12:06:29'),
	(38, '用户名为{admin}，角色为{超级管理员}的用户登录成功!', '2018-12-22 12:17:20'),
	(39, '用户名为{admin}，角色为{超级管理员}的用户登录成功!', '2018-12-22 12:21:20'),
	(40, '用户名为{admin}，角色为{超级管理员}的用户登录成功!', '2018-12-22 13:05:44'),
	(41, '用户名为{admin}，角色为{超级管理员}的用户登录成功!', '2018-12-22 13:07:30'),
	(42, '用户名为{admin}，角色为{超级管理员}的用户登录成功!', '2018-12-22 13:16:00'),
	(43, '用户名为{admin}，角色为{超级管理员}的用户登录成功!', '2018-12-22 14:28:56'),
	(44, '用户名为{admin}，角色为{超级管理员}的用户登录成功!', '2018-12-22 14:33:41'),
	(45, '用户名为{admin}，角色为{超级管理员}的用户登录成功!', '2018-12-22 15:31:07'),
	(46, '用户名为{admin}，角色为{超级管理员}的用户登录成功!', '2018-12-22 15:35:02'),
	(47, '用户名为{admin}，角色为{超级管理员}的用户登录成功!', '2018-12-22 15:36:32'),
	(48, '用户名为{admin}，角色为{超级管理员}的用户登录成功!', '2018-12-22 16:06:20'),
	(49, '用户名为{admin}，角色为{超级管理员}的用户登录成功!', '2018-12-22 16:09:48'),
	(50, '用户名为admin的用户登录时输入验证码错误!', '2018-12-22 16:19:05'),
	(51, '用户名为{admin}，角色为{超级管理员}的用户登录成功!', '2018-12-22 16:19:20'),
	(52, '用户名为admin的用户登录时输入验证码错误!', '2018-12-22 16:20:47'),
	(53, '用户名为{admin}，角色为{超级管理员}的用户登录成功!', '2018-12-22 16:20:59'),
	(54, '用户名为{admin}，角色为{超级管理员}的用户登录成功!', '2018-12-23 11:10:10'),
	(55, '用户名为{admin}，角色为{超级管理员}的用户登录成功!', '2018-12-23 12:38:51'),
	(56, '用户名为{admin}，角色为{超级管理员}的用户登录成功!', '2018-12-23 14:39:48'),
	(57, '用户名为admin的用户登录时输入验证码错误!', '2018-12-23 21:29:13'),
	(58, '用户名为{admin}，角色为{超级管理员}的用户登录成功!', '2018-12-23 21:29:23'),
	(59, '用户名为{admin}，角色为{超级管理员}的用户登录成功!', '2018-12-23 21:39:25'),
	(60, '用户名为{admin}，角色为{超级管理员}的用户登录成功!', '2019-10-10 21:53:57'),
	(61, '用户名为admin的用户登录时输入密码错误!', '2019-10-10 21:56:19'),
	(62, '用户名为{admin}，角色为{超级管理员}的用户登录成功!', '2019-10-10 21:58:30'),
	(63, '用户名为{admin}，角色为{超级管理员}的用户登录成功!', '2019-10-10 22:06:09'),
	(64, '用户名为{admin}，角色为{超级管理员}的用户登录成功!', '2019-10-10 22:12:36'),
	(65, '用户名为{ghasfas}，角色为{普通用户}的用户登录成功!', '2019-10-10 22:13:05'),
	(66, '用户名为{ghasfas}，角色为{普通用户}的用户登录成功!', '2019-10-10 22:21:37'),
	(67, '用户名为{admin}，角色为{超级管理员}的用户登录成功!', '2019-10-11 12:08:15'),
	(68, '用户名为{admin}，角色为{超级管理员}的用户登录成功!', '2019-10-11 12:13:11');
/*!40000 ALTER TABLE `log` ENABLE KEYS */;

-- Dumping structure for table ssm_news_sys.menu
...
-- Dumping data for table ssm_news_sys.menu: ~34 rows (approximately)
...
INSERT INTO `menu` (`id`, `parentId`, `name`, `url`, `icon`) VALUES
	...
	(37, 0, '新闻管理', '', 'icon-feed'),
	(38, 37, '分类管理', '../admin/news/list', 'icon-feed-star'),
	(39, 38, '添加', 'openAdd()', 'icon-add'),
	(40, 38, '编辑', 'openEdit()', 'icon-bullet-edit'),
	(41, 38, '删除', 'remove()', 'icon-cross'),
	(42, 37, '新闻管理', '../admin/news/list', 'icon-feed-edit'),
	(43, 42, '添加', 'openAdd()', 'icon-add'),
	(44, 42, '编辑', 'openEdit()', 'icon-bullet-edit'),
	(45, 42, '删除', 'remove()', 'icon-cross'),
	(46, 37, '评论管理', '../admin/comment/list', 'icon-comment'),
	(47, 46, '添加', 'openAdd()', 'icon-add'),
	(48, 46, '编辑', 'openEdit()', 'icon-bullet-edit'),
	(49, 46, '删除', 'remove()', 'icon-cross');
/*!40000 ALTER TABLE `menu` ENABLE KEYS */;

-- Dumping structure for table ssm_news_sys.news
...
-- Dumping data for table ssm_news_sys.news_category: ~6 rows (approximately)
...
-- Dumping structure for table ssm_news_sys.role
...
-- Dumping data for table ssm_news_sys.role: ~3 rows (approximately)
...
-- Dumping structure for table ssm_news_sys.user
...
-- Dumping data for table ssm_news_sys.user: ~2 rows (approximately)
/*!40000 ALTER TABLE `user` DISABLE KEYS */;
INSERT INTO `user` (`id`, `username`, `password`, `roleId`, `photo`, `sex`, `age`, `address`) VALUES
	(1, 'admin', 'admin', 1, '/ssm_news_sys/resources/upload/1545572488494.jpg', 1, 1, '上海市浦东新区浦东南路1835号'),
	(13, 'ghasfas', '123456', 2, '/ssm_news_sys/resources/upload/1545572546524.jpg', 1, 1, 'ghasfas');
