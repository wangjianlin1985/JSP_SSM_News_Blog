	...
	<div class="tab-content">
	  <div role="tabpanel" class="tab-pane contact active" id="notice">
		...
		<div role="tabpanel" class="tab-pane contact" id="contact">
		  ...
		  <h4>
		  <a href="#" target="_blank" data-toggle="tooltip" rel="nofollow" data-placement="bottom" title=""  data-original-title="敬请期待">更多信息尽在实时发布系统</a></h4>
	  </div>
	</div>
  </div>
...
<div class="widget widget_sentence">
  ...
  <div class="widget-sentence-link">
	<a href="http://www.cwnu.edu.cn/" title="西华师大官网" target="_blank" >官方网站</a><br>
	<a href="http://210.41.193.28/web/web/mis/" title="教学管理系统" target="_blank" >教学管理系统</a>&nbsp;&nbsp;&nbsp;
  </div>
</div>
</aside>
<script>
...
$(document).ready(function(){
	...
	$.ajax({
		url:'../news/get_recommed_list?id='+getQueryVariable('id'),
		type:'get',
		dataType:'json',
		success:function(data){
			if(data.type == 'success'){
				...
				$("#last-recommed-list").append(html);
			}
		}
	});
	$.ajax({
